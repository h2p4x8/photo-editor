...
Добавленные пользователем комментарии должны сохраняться при обновлении страницы.
...
Созданные пользователем рисунки должны сохраняться при обновлении страницы.
